...
def print_ingredients():  # Ways to work with strings/printing
    ...
    print('ingredient_1'), print('ingredient_2'), print('ingredient_3'), print('ingredient_4')
...
def confirm_ingredients():  # String methods
    ...
    print("ingredient.replace{'milk','butter'}")
...
def favorite_bake():  # User Input/Type conversion
    ...
    frequency = input(f'Roughly how many times a moth do you eat {baked_good}')
    ...
    print(f'We recommend you eat {baked_good}s at least {frequency} times a month!')
